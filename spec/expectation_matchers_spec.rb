describe 'Expectation Matchers' do
  describe 'equivalance machers' do
    it "will match loose equality with #eq" do
      ...
      c = 12
      d = 12.0
      expect(c).to eq(d)        # differernt types, "close enough"
    end

    it "will match value equality #eql" do
      a = "2 cats"
      b = "2 cats"
      expect(a).to eql(b)       # just a little stricter - checks for data type as well
    ...
    it "will match indentity equality with #equal" do
      a = "2 cats"
      b = "2 cats"
  ...
  describe 'truthiness matchers' do
    it 'will match true/false' do
      ...
      expect(nil).not_to be(false)    # nil is not exaclty false
    ...
    it 'will match truthy/falsey' do
      ...
      expect('foo').to be_truthy      # nil counts as false true
  ...
  describe 'nuemeric comparison matchers' do
  ...
  describe 'collection mathers' do
    ...
    it 'will match hashes' do
      ...
      expect(hash).to include(:a, :b, :c)
      
      expect(hash).to include(:a => 1, :b => 2)
      expect(hash).to include({:a => 1, :b => 2, :c => 3})

      expect(hash).not_to include({'a' => 1, 'c' => 3}) # as it defaults in ruby symbol key won't match with string key
    end    
  end

  describe 'other useful matchers' do
    it 'will match strings with a regex' do
      # This matcher is a good wat to spot check strings
    ...
    it 'will match object types' do
      ...
      expect('test').to be_an_instance_of(String)  # alias of #be_instace_of
    ...
    it 'will match class isntances with #have_attributes' do
      class Car
  ...
  describe 'observation matchers' do
    ...
    # It is a special black format that allows a
    # process to take place inside of the exepctations.
    ...
    it 'will match when events change any values' do
      # calls the test before the clock,
      # then again after the block
    ...
    it 'will match when errors are raised' do
      # observes any errors raisede by the block
  ...
  describe 'composing matchers' do
    # some matchers accept machers as arguments. (new in rspec3)
    ...
    it 'will match by sending machers as arguments to machers' do
      string = 'hello'
    ...
    it 'will match using noun-phrase aliases for matchers' do
      ...
      # specs read better by using noun-bases
      ...
      # improved vesrion of the previous example 
