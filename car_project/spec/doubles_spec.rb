describe 'Doubles' do
  ...
  context 'with partial test doubles' do
    it 'allows stubbing instance methods on Ruby classes' do
      ...
      expect(time.to_s).to eq('2010-01-01 12:00:00 +0530')
    ...
    it 'allows stubbing class methods on Ruby Classes' do
      ...
      expect(Time.now.to_s).to eq('2010-01-01 12:00:00 +0530')
  ...
  context 'with message expectaions' do
